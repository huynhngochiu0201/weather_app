...
class WeatherDetail {
  ...
  factory WeatherDetail.fromJson(String source) =>
      WeatherDetail.fromMap(jsonDecode(source) as Map<String, dynamic>);
}
...
// 20240312153342
// https://api.openweathermap.org/data/2.5/weather?lat=16,05310&units=metric&lon=108,17090&appid=21e34bef9ac77f4bb12cc472e27c0e58
